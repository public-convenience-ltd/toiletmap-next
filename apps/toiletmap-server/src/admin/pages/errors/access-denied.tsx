  ...
  return (
    <Layout title="Admin access required">
      <section class="empty-state" style="margin-top: var(--space-xl);">
        ...
        <p>
          Hi {displayName}, your account does not have the required <code>{ADMIN_ROLE_ID}</code>{" "}
          permission. The dataset explorer and contributor tooling are reserved for Toilet Map
          administrators.
        </p>
        {identityLabel && (
        ...
        <p style="margin-top: var(--space-s);">
          Please ask your project administrator to grant you access, or sign out below to switch to
          a different account.
        </p>
        <div
          style="
