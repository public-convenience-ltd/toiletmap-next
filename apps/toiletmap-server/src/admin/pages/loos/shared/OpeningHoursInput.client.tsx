                                    ...
                                    <div class="time-controls">
                                        <label class="checkbox-label">
                                            <input
                                                type="checkbox"
                                                checked={is24h}
                                                onChange={(e) => handle24hToggle(index, (e.target as HTMLInputElement).checked)}
                                            />
                                            <span>24 Hours</span>
                                        </label>
                                        ...
                                        {!is24h && (
                                            <div class="time-inputs">
                                                <input
                                                    type="time"
                                                    value={times[0]}
                                                    onChange={(e: any) => handleTimeChange(index, 'open', (e.target as HTMLInputElement).value)}
                                                ...
                                                <input
                                                    type="time"
                                                    value={times[1]}
                                                    onChange={(e: any) => handleTimeChange(index, 'close', (e.target as HTMLInputElement).value)}
                                                    class="input time-input"
