...
const renderSortIcon = (sortBy: SortKey | "", sortOrder: SortOrder, colKey: SortKey) => {
  if (!sortBy || sortBy !== colKey) {
    return <i class="fa-solid fa-sort sort-icon" aria-hidden="true" />;
  }
  if (sortOrder === "asc") {
    return <i class="fa-solid fa-sort-up sort-icon" aria-hidden="true" />;
  }
  return <i class="fa-solid fa-sort-down sort-icon" aria-hidden="true" />;
};
...
export const loosList = (c: Context<{ Bindings: Env }>) => {
  ...
  const normalizedSortParam =
    sortParam && SORT_COLUMNS.includes(sortParam as SortKey) ? (sortParam as SortKey) : null;
  ...
  const _appliedFilters = TABLE_FILTERS.map((filter) => {
  ...
  const _clearFiltersUrl = buildUrl(state, clearFiltersOverrides);
  ...
  return c.html(
    <Layout title="Loos">
      ...
      <section class="stats-panel stats-panel--collapsed" data-loos-metrics>
        <div class="stats-panel__header">
          <div class="stats-summary">Loading insights…</div>

          <button type="button" class="stats-toggle">
        ...
        <div class="stats-panel__content">
          ...
          <div class="stat-sections">
            <div class="stat-section">
              ...
              <ul class="stat-progress-list" data-loos-feature-list hidden />
            </div>
            ...
            <div class="stat-section">
              ...
              <ul class="stat-list" data-loos-area-list hidden />
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="table-section">
        <div class="table-overflow" data-loos-table-root>
          ...
          <div class="async-state async-state--error" data-loos-table-error hidden>
            ...
            <button type="button" class="button" data-loos-retry>
              Try again
            </button>
          </div>
      ...
      />
      <div id="loos-app-root" />
      <script type="module" src="/admin/loos-list.js" />
    </Layout>,
  );
};
