...
import type { ScriptState, SearchResponse, MetricsResponse, FilterMappings } from '../utils/types';
import { buildSearchParams, buildMetricsParams } from '../utils/builders';
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                const search = await fetchJson<SearchResponse>(searchEndpoint, searchParams, controller.signal);
                ...
                try {
                    ...
                    const metrics = await fetchJson<MetricsResponse>(metricsEndpoint, metricsParams, controller.signal);
