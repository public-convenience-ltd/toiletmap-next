...
import { percentage, formatNumber } from '../utils/formatters';
        ...
        <section class={`stats-panel ${isCollapsed ? 'stats-panel--collapsed' : ''}`} data-loos-metrics>
            <div class="stats-panel__header">
                <div class="stats-summary">
                    {isCollapsed ? (
                        <span>
                            {formatNumber(totalCount)} loos • {formatNumber(totals.active || 0)} active • {formatNumber(totals.accessible || 0)} accessible
                        </span>
                    ) : (
