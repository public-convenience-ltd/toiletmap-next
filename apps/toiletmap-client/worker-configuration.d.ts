/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce944453872d7f90fe3e4eb4b72ba3bf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_API_URL">> {}
}
