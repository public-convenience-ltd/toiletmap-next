/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e0a7d0f0e889afeb6e5e34c69d7b0de2)
// Runtime types generated with workerd@1.20251118.0 2025-11-18 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		POSTGRES_URI: string;
		AUTH0_DATA_EXPLORER_CLIENT_ID: string;
		AUTH0_DATA_EXPLORER_SCOPE: string;
		AUTH0_DATA_EXPLORER_REDIRECT_URI: string;
		PLAYWRIGHT_AUTH0_CLIENT_ID: string;
		PLAYWRIGHT_AUTH0_CLIENT_SECRET: string;
		PLAYWRIGHT_AUTH0_USERNAME: string;
		PLAYWRIGHT_AUTH0_PASSWORD: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_SCANNER_BUFFER_SIZE" | "DATABASE_NAME" | "AUTH0_DOMAIN" | "AUTH0_AUDIENCE" | "AUTH0_PERMISSIONS_KEY" | "AUTH0_PROFILE_KEY" | "AUTH0_ISSUER_BASE_URL" | "POSTGRES_URI" | "AUTH0_DATA_EXPLORER_CLIENT_ID" | "AUTH0_DATA_EXPLORER_SCOPE" | "AUTH0_DATA_EXPLORER_REDIRECT_URI" | "PLAYWRIGHT_AUTH0_CLIENT_ID" | "PLAYWRIGHT_AUTH0_CLIENT_SECRET" | "PLAYWRIGHT_AUTH0_USERNAME" | "PLAYWRIGHT_AUTH0_PASSWORD">> {}
}
declare module "src/generated/prisma/internal/query_compiler_bg.wasm" {
